        ...
        <section className="inicio" id="inicio">
            ...
            <div className="titulo">
                ...
                <h1 data-aos="fade-up" data-aos-delay="800">
                    <FormattedMessage
                        id='name'
                        defaultMessage='I am Mohamed Eltantawy'
                    />
                </h1>
                ...
                <div className="wrapper">
                    ...
                    <a className="button" href="https://github.com/Eltantawy-Dev/" target="_blank" rel="noopener noreferrer" data-aos="fade-up" data-aos-delay="1400">
                        <div className="icon">
                    ...
                    <a className="button" href="https://api.whatsapp.com/send?phone=201559258815" target="_blank" rel="noopener noreferrer" data-aos="fade-up" data-aos-delay="1800">
                        <div className="icon">
